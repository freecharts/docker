...
docker run -d -p 15432:5432 --network pg -e POSTGRES_PASSWORD=postgres --name pg01 postgres:17.10 -c default_transaction_isolation='repeatable read'
docker run -d -p 25432:5432 --network pg -e POSTGRES_PASSWORD=postgres --name pg02 postgres:17.10 -c default_transaction_isolation='repeatable read'
docker run -d -p 5432:5432 --network pg -e BACKEND_HOSTS=pg01:5432,pg02:5432 -e PGPOOL_BACKEND_USER=postgres -e PGPOOL_BACKEND_PASSWORD=postgres --name pool pgpool:4.6.1-2.2
```
